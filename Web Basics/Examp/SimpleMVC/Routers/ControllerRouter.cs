    ...
    public class ControllerRouter
    {
        ...
        public void ParseInput()
        {
            ...
            this.controllerAction =
                this.controllerActionParams[0].Split(new[] { '/' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            this.controllerName = string.Format(
                "{0}{1}",
                this.controllerAction[this.controllerAction.Length - 2].ToUpperFirst(),
        ...
        private Controller GetController()
        {
            ...
            var controller = (Controller)Activator.CreateInstance(
                MvcContext.Current.ApplicationAssembly.GetType(controllerType));
            return controller;
        }
