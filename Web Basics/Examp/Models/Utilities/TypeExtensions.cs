        ...
        public static HomeGameViewModel GetGameMappedToHomeGameViewModel(this Game game)
        {
            return Mapper.GetMapped(
                ...
                hgvm => new HomeGameViewModel
                {
                    ...
                    Price = game.Price,
                    Size = game.Size,
                    Description = string.Join(string.Empty, game.Description.ToCharArray().Take(300))
                });
        }
